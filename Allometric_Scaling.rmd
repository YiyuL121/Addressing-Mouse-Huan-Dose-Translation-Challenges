...
```{r}
pop_data <- read.csv("populationParameters.txt",  row.names = 1)
...
```{r}
human_result <- read.csv("populationParameters.txt", row.names = 1)
...
pop <- read.csv("C:/Users/YIYU.LIAO/OneDrive - Nanyang Technological University/Desktop/Determine Vacc dose/Human model/Age_less_than60/log__r33/populationParameters.txt", row.names = 1)
